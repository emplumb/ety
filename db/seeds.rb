# terms = [
  ...
  # notes2: "",
  # quote: "\"Quien no sabe de abuelo, no sabe de bueno.\" He who does not know their grandfather, does not know what is good. Spanish proverb. \"Ay, abuelo, sembráste alazor, y naciónos anapelo.\" 18th century proverb. The origin, Stevens (1725) recounts, comes from \"a grandfather who marry'd a granddaughter to one he had great conceit of, and he proved a meer rake; whereupon another granddaughter cry'd, \"Grandfather, you sow'd saffron (which is rich and cordial, meaning he thought he had got an excellent son-in-law) and there came up poisonous wolfsbane;\" that is, he proved a vile husband.\" This popular etymology is echoed in Caro y Cejudo (1792)."
  # },
...
# end
    ...
    (2..ss.last_row).each do |row|
      ...
      Term.create!(:name => name, :gender => gender, :prefix_suffix => prefix_suffix, :part_of_speech => part_of_speech, :definition => definition, :etymology1 => etymology1, :etymology2 => etymology2, :uses => uses, :romance_cognates => romance_cognates, :notes1 => notes1, :notes2 => notes2, :quote => quote)
    end

...
Term.create!([
  ...
  etymology2: "",
  uses: "",
  romance_cognates: "Asturian <i>cabeza</i>, Portuguese <i>cabeça</i>, Galician <i>cabeza</i>, Italian <i>cavezza</i>.  Western Vulgar Latin reanalyzed the neuter plural as a feminine singular noun (see <b><a href='/directory/arma'>arma</a></b> and <b><a href='/directory/hoja'>hoja</a></b>).",
  notes1: "Similar to other rogue colloquialisms in Vulgar Latin like <b><a href='/directory/buscar'>buscar</a></b>, cabeza is present only in Iberian Romance languages and Italian. Its absence in other branches is conspicuous.",
  notes2: "",
  quote1: "",
  quote2: ""},
